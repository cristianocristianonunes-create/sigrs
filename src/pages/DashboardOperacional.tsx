...
import {
  ...
  GraduationCap, BarChart3, Gauge, Activity
} from "lucide-react";
...
const dailyCards = [
  { label: "Coletados Hoje", value: "12,4 ton", icon: Trash2, color: "bg-primary/10 text-primary" },
  { label: "Coletas Realizadas", value: "18", icon: Truck, color: "bg-primary/10 text-primary" },
  { label: "Economia do Mês", value: "R$ 148mil", icon: DollarSign, color: "bg-success/10 text-success" },
  { label: "Receita do Mês", value: "R$ 225mil", icon: TrendingUp, color: "bg-success/10 text-success" },
  { label: "Alertas Ativos", value: "3", icon: AlertTriangle, color: "bg-loss/10 text-loss" },
];
...
const kpis = [
  { label: "Taxa de Reciclagem", value: 62, target: 70, unit: "%" },
  { label: "Desvio de Aterro", value: 65, target: 75, unit: "%" },
  { label: "Custo/Tonelada", value: 85, target: 100, unit: "R$" },
  { label: "Eficiência Triagem", value: 78, target: 85, unit: "%" },
];

const plantStatus = {
  capacity: 72,
  processed: "248 ton/sem",
